...
import es.dtr.job.interview.commons.data.type.email.EmailDatabase;
import es.dtr.job.interview.commons.data.type.password.PasswordDatabaseConverter;
...
public class UserEntity {
    ...
    public void merge(final UserEntity changes) {
