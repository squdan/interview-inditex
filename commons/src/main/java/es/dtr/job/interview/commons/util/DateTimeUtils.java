...
public final class DateTimeUtils {
    ...
    // Formatter
    public final static String DATE_TIME_FORMAT_DEFAULT = "yyyy-MM-dd'T'HH:mm:ss'Z'";
    ...
    public static class StringDateUtils {
        ...
        public final static String DATE_TIME_FORMAT_1 = "yyyy-MM-dd'T'HH:mm:ss.SSSXXX";
        public final static String DATE_TIME_FORMAT_2 = "yyyy-MM-dd'T'HH:mm:ss";
        public final static String DATE_TIME_FORMAT_3 = "yyyy-MM-dd'T'HH:mm:ss.SSS";
        protected final static List<DateTimeFormatter> EXTRA_SUPORTED_FORMATS = List.of(
                DateTimeFormatter.ISO_OFFSET_DATE_TIME,
                DateTimeFormatter.ofPattern(DATE_TIME_FORMAT_1),
                DateTimeFormatter.ofPattern(DATE_TIME_FORMAT_2),
                DateTimeFormatter.ofPattern(DATE_TIME_FORMAT_3)
        );
        ...
        static {
            ...
            FORMATTERS.addAll(EXTRA_SUPORTED_FORMATS);
        }

        /**
         * Returns received String as Date, must follow the next format
         * {@link DateTimeUtils.DATE_TIME_FORMAT_DEFAULT}
         * <p>
