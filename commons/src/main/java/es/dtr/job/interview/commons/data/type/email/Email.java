...
/**
 * Objeto que contiene información extendida del email.
 * <p>
 * username: Identificador del usuario.
 * <p>
 * domain: Dominio origen del email.
 * <p>
 * organization: Organización de origen del email.
 * <p>
 * type: Tipo de organización de origen del email.
 * <p>
 * email: Dirección email completa (test@nosolosoftware.es).
 */
@Getter
